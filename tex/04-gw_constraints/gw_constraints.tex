\section{Confrontation with Gravitational-Wave Observations}
  ...
  \subsection{Mapping to the LVK Parametrization}
    ...
    \[
      \ell_\chi
      \lesssim
      \sqrt{\frac{A_4^{\mathrm obs}}{\gamma}}
      =
  ...
  \subsection{Robustness and Scheme Dependence}
    ...
    \begin{itemize}
      ...
      \item The structure of the dispersion is fixed by the ratio of
      Seeley--DeWitt coefficients.
      \item The constraint on $\ell_\chi$ scales as
      $\sqrt{\zeta}$ and is therefore stable up to factors of order unity.
    \end{itemize}
