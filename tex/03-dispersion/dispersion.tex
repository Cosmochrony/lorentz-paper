\section{Modified Dispersion from Spectral Coefficients}
  ...
  \subsection{Quadratic Operator and Pole Structure}
    ...
    In the transverse-traceless sector established in
    Section~\ref{sec:ir_spectrum},
    ...
    \[
      ...
      \left(
        1
        +
        \frac{\beta}{c_{\mathrm{EH}}}\Box
      \right).
    \]

    The coefficient $\beta$ originates from the Weyl-squared term in the
    renormalized spectral expansion.
    For a Laplace-type scalar minimal operator in four dimensions,
